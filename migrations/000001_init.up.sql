...
INSERT INTO templates (id, "name", description, price) VALUES
    ...
    ('550e8400-e29b-41d4-a716-446655550004'::uuid, 'Скейтборд', 'Для перевозки небольших грузов', 200.00),
    ('550e8400-e29b-41d4-a716-446655550005'::uuid, 'Моноколесо', 'Для активной езды', 180.00);
